	...
	<div class="row" style="width: 30%;margin: 0 auto;padding-top: 20px">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<a href="${pageContext.request.contextPath}/alipay?oid=${order.id }&money=${order.money }" class="btn btn-warning">支付宝</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${pageContext.request.contextPath}/payWeixin.jsp?oid=${order.id }" class="btn btn-success">微信</a>
			</div>
		</div>
